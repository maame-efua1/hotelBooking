...
namespace BookWithEase.Controllers
{
    public class BookingController : Controller
    {
        ...
        private const string stayduration = "";
        ...
        public IActionResult AvailableRooms(string guests, DateOnly checkIn, DateOnly checkOut, int stayDuration)
        {
            ...
            HttpContext.Session.SetString("stayduration", stayDuration.ToString());
        ...
        public IActionResult ConfirmBooking(int roomid)
        {
            ...
            var stayDuration = HttpContext.Session.GetString("stayduration");
            ...
            booking.stayDuration = stayDuration;
